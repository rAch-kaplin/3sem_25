...
#define DLOG(fmt, ...) LOG(LOGL_DEBUG, fmt, ##__VA_ARGS__)
#define ILOG(fmt, ...) LOG(LOGL_INFO,  fmt, ##__VA_ARGS__)
#define WLOG(fmt, ...) LOG(LOGL_WARN,  fmt, ##__VA_ARGS__)
#define ELOG(fmt, ...) LOG(LOGL_ERROR, fmt, ##__VA_ARGS__)
